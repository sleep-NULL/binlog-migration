...
public class WriteRowsEvent extends RowsEvent {
	...
	public WriteRowsEvent(ByteBuffer buf, Map<Long, TableMapEventAndColumns> tableMap) throws IOException {
		super(buf);
	...
	public String toString() {
		return "WriteRowsEvent [tableId=" + tableId + ", flags=" + flags + ", extraData=" + extraData + ", columnCount="
				+ columnCount + ", bitmap=" + Arrays.toString(bitmap) + ", rows=" + rows + "]";
	}
