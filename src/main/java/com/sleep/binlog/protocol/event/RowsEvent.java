...
//		case ColumnType.MYSQL_TYPE_NULL:
	...
	private int getFractionalSeconds(int meta) {
        ...
        if (fractionalSecondsStorageSize > 0) {
            long fractionalSeconds = bigEndianLong(read(fractionalSecondsStorageSize), 0,
    ...
    protected Serializable[] deserializeRow(TableMapEvent tableMapEvent,int[] nullBitmap, int numOneBitmap) throws IOException {
